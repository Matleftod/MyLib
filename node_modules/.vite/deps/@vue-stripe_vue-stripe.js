  ...
  "node_modules/@vue-stripe/vue-stripe/dist/index.js"(exports) {
    ...
    var runtime_1 = createCommonjsModule(function(e) {
      var n = function(e2) {
        ...
        var E = Object.getPrototypeOf, _ = E && E(E(x([])));
        _ && _ !== t && r.call(_, o) && (g = _);
          ...
          switch (t.prev = t.next) {
            ...
            case 4:
              this.stripe = t.sent, this.stripe.registerAppInfo(STRIPE_PARTNER_DETAILS), this.elements = this.stripe.elements(this.elementsOptions), this.element = this.elements.create(ELEMENT_TYPE$1, this.createOptions), this.element.mount("#stripe-payment-element-mount-point"), this.element.on("change", function(e2) {
                ...
                var t2, r;
                return regenerator.async(function(i) {
                  for (; ; )
                    switch (i.prev = i.next) {
                      case 0:
                        return i.prev = 0, n.$emit("loading", true), e2.preventDefault(), i.next = 5, regenerator.awrap(n.stripe.confirmPayment({ elements: n.elements, confirmParams: n.confirmParams, redirect: n.redirect }));
                      case 5:
                        if (t2 = i.sent, !(r = t2.error)) {
                          i.next = 12;
                          break;
                        }
                        return document.getElementById("stripe-payment-element-errors").textContent = r.message, n.$emit("error", r), i.abrupt("return");
                      case 12:
                        i.next = 18;
                        break;
                      case 14:
                        i.prev = 14, i.t0 = i.catch(0), console.error(i.t0), n.$emit("error", i.t0);
                      case 18:
                        return i.prev = 18, n.$emit("loading", false), i.finish(18);
                      case 21:
                      case "end":
                        return i.stop();
                    }
                }, null, null, [[0, 14, 18, 21]]);
              });
            case 16:
            case "end":
              return t.stop();
...
`] }, media: void 0 });
    ...
    var __vue_component__$1 = normalizeComponent({ render: __vue_render__$1, staticRenderFns: __vue_staticRenderFns__$1 }, __vue_inject_styles__$1, __vue_script__$1, "data-v-3329b3f8", false, void 0, false, createInjector, void 0, void 0);
